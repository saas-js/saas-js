...
All props of the [Ark UI FileUpload component](https://ark-ui.com/react/docs/components/file-upload#api-reference) are supported.

## FileUpload.Context

The `FileUpload.Context` component receives an `slingshot` object that contains the Slingshot client API.
