Thanks for showing interest to contribute to Saas.js 💖, you rock!
...
1. Fork the repo (click the <kbd>Fork</kbd> button at the top right of
   [this page](https://github.com/saas-js/saas-js))

2. Clone your fork locally

```sh
git clone https://github.com/<your_github_username>/saas-js.git
cd saas-js
```
...
3. Make and commit your changes following the
   [commit convention](https://github.com/saas-js/saas-js/blob/main/CONTRIBUTING.md#commit-convention).
...
By contributing your code to the saas-js GitHub repository, you agree to
